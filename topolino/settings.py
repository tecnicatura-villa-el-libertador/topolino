"""
Django settings for topolino project.
...
SECRET_KEY = 'qdstjnvrrl_dz-ne7$@u09)wf#+mf@y+wusc790gexhs71l_58'
...
WSGI_APPLICATION = 'topolino.wsgi.application'
